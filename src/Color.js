...
export default function Model(props) {
  ...
  const { bodyMetalness, bodyRoughness, cylindersMetalness, cylindersRoughness } = useTweaks({
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh receiveShadow geometry={nodes.Cube.geometry} position={[0, 1, 0]} rotation-x={Math.PI / 2}>
        <primitive object={materials.black} attach="material" metalness={bodyMetalness} roughness={bodyRoughness} />
      </mesh>
